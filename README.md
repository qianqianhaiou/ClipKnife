...
简单说：把素材文件夹交给素刀，它会在本机扫描、建库、分镜和索引；之后你可以用一句自然语言搜索本地图片和视频片段，例如“海边日落”“红色包装特写”“有人走进办公室”，支持以图搜图。
...
软件下载、版本更新日志和产品说明请见官网：<https://clipknife.cn/>

遇到问题或想提建议，请在本仓库提交 [Issue](https://github.com/qianqianhaiou/ClipKnife/issues)，反馈请尽量附：
...
素刀当前处于**公测阶段**，免费下载、安装后自动激活。这个仓库用于文档、使用手册和问题反馈（不含源码）。`project`、`toolbox` 等入口目前是预留页面。
